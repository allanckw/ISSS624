...
From the result, there are 6 LGAs that have the same names, even though they are from different states.
We will want to rename them or it would be confusing when we conduct further analysis.
...
nga_wp$ADM2_EN[nga_wp$ADM2_PCODE=="NG020031"] = "Nasarawa (Kano)"
nga_wp$ADM2_EN[nga_wp$ADM2_PCODE=="NG026009"] = "Nasarawa (Nasarawa)"

nga_wp$ADM2_EN[nga_wp$ADM2_PCODE=="NG007014"] = "Obi (Benue)"
nga_wp$ADM2_EN[nga_wp$ADM2_PCODE=="NG026011"] = "Obi (Nasarawa)"

nga_wp$ADM2_EN[nga_wp$ADM2_PCODE=="NG025020"] = "Surulere (Lagos)"
nga_wp$ADM2_EN[nga_wp$ADM2_PCODE=="NG031033"] = "Surulere (Oyo)"
```

We then change the row names to the names of the LGAs

```{r}
row.names(nga_wp) <- nga_wp$ADM2_EN
```
