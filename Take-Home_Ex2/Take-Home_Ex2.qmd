...
rect.hclust(nongeo_cluster, k=9, border = 2:9)
```
...
tmap_arrange(hclust_map_without_spatial_constraints,skatermap, 
             default_ngeo_clustered_map, g_clustered_map, 
             ncol = 2, nrow = 2, asp = 1,
             sync = TRUE)
...
We can see that the SKATER map generated a map that assumed that the bulk of the water points were homogeneous, creating a relatively large cluster (Cluster 4). Due to the size of the cluster, this may not be the right approach for this data set. This is evident from the map generated below. The area in cluster 4 is unlikely to be homogeneous
...
From the ClustGeo map, we could infer
...
-   The western borders of Nigeria forms a cluster on its own

These observation were similar to the observation we made in the section *Visualizing the spatial distribution of water points.*

## Visual Interpretation of Clusters

skatermap - SP_CLUSTER

nga_Gcluster - CLUSTER
