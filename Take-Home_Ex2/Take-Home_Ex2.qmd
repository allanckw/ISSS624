...
The result of cluster 4 which spans 388 LGAs is unlikely to be homogeneous if we want to look at how non-functional water points are distributed. In order to look for more insights, lets take a look at the results produced by the ClustGeo package.
...
-   Can we find out what variables will affect water points containing potable water to become non functional and how can we make them functional again to serve the population
