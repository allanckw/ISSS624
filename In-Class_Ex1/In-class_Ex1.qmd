...
We will need to compute the distances between areas using `nbdistI()` of **spdep** package
...
Lists of non-neighbors are possible with the zero.policy=TRUE option.
