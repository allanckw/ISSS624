...
We will use the `mutate()` function to modify *usage_capacity* into categorical variables as it is not a continuous variable, as they can be broken down into either 300, 500 or 1000. We shall categorize them into Small (300), Medium (500) and Large (1000) instead.
