...
-   97.72% of such non functional water points are made up of wells. We could ask the question if we could improve things by providing other forms of sources such as pipe water. How much cost will it take to bring pipe water to the various state of Nigeria?
...
5.  Define the quadrants levels
    ...
    quadrant[DV < 0 & LM_I > 0] = 1 #L_MI > 0 -> cluster, DV < 0 low-low pattern
    quadrant[DV < 0 & LM_I < 0] = 2 #L_MI < 0 -> outlier,  DV < 0 Low High
    quadrant[DV > 0 & LM_I < 0] = 3 #L_MI < 0 -> outlier,  DV < 0 High Low
    quadrant[DV > 0 & LM_I > 0] = 4 #L_MI > 0 -> cluster, DV > 0 high-high pattern
    ```
